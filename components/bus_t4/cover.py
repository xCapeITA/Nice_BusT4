...
# Definizione del namespace e aggancio classe lupanosix_blu
...
def to_code(config):
    ...
    # Gestione dell'indirizzo destinazione nell'array di byte nativo C++
    ...
    # Gestione dell'indirizzo sorgente del gateway nell'array di byte nativo C++
